...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>ABC Hotel SSDI Team -11</title>
		...
		<header id="fh5co-header-section">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a href="index.html">ABC Hotel</a></h1>
						...
						<form action="AddRoomServlet">
						 ...
						 <div class="row">
						  ...
						  <div class="col-md-4">
							...
							<div class="col-md-4">
							<div class="form-group">
							<h4 class="active">Room Id</h4>
							<input type="text" class="form-control" id="roomid" name="roomid" placeholder="id">
							</div>
							</div>
							...
							<input type="text" class="form-control" id="roomprice" name="roomprice" placeholder="40">
							</div>
							</div>
							
							<div class="col-md-6">
							<div class="form-group">
							<button type="submit" class="btn btn-primary col-md-12" "form-group">ADD</button>
							...
							<div class="col-md-6">
							<div class="form-group">
							<button type="submit" class="btn btn-primary col-md-12" "form-group">BACK</button>
