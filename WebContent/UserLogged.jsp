				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li><a class="active" href="LogOutServlet">Log out</a></li>
								 	<li><a class="active" href="ShowReservationsServlet">View Reservation</a></li>
			...
			<div class="row">
				<div id="availability">
					...
					<form action="RoomServlet">
						...
						<div class="a-col alternate" name="date-start">
							<div class="input-field">
								<label for="date-start">Check In</label>
								<input type="text" class="form-control" id="date-start"  name="date-start"/>
							</div>
						</div>
						<div class="a-col alternate" name="date-end">
							<div class="input-field">
						...
						<button type="submit" class="btn btn-primary col-md-12" "form-group">Check Availability</button>
