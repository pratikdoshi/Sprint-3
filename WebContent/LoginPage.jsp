				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li>
								<a href="#Visit" class="fh5co-sub-ddown">Visit Us</a>
						...
						<form action="LoginnServlet">
						 ...
						 <div class="row">
						  ...
						  <div class="col-md-12">
							...
							<div class="col-md-12">
							<div class="form-group">
							<button type="submit" class="btn btn-primary col-md-12" "form-group">Login</button>
							<span class="psw">Need an account? <a href="SignUp.jsp">Sign-up</a></span> <!-- link to sign-up page -->
							</div>
							</div>
